...
def coco2kitti(cat_names, ann_files, save_dir):
...
if __name__ == '__main__':
    ...
    output_dir = os.getcwd() + '/model_data/kitti/'

    # Check if old file exits.
    dir_list = os.listdir(output_dir)
    if len(dir_list) > 0:
        for dir_name in dir_list:
            shutil.rmtree(os.getcwd() + '/model_data/kitti/' + dir_name)
